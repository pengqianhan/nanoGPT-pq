...
if init_from == 'scratch':
    ...
    model = GPT.from_pretrained(init_from, override_args)## Specify the path for downloading model weights
...
'''
model是一个经过DataParallel或DistributedDataParallel包装后的模型实例。
model.module访问的是被包装的原始模型。
'''
